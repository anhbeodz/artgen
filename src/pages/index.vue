  ...
  <div class="container m-auto" v-if="display">
      ...
      >
        <template #item="{ element, index }">
          <div class="xl:flex-[0_0_12.5%] lg:flex-[0_0_16.6666%] md:flex-[0_0_33.3333%] flex-[0_0_100%] mb-[30px] pt-[14px]">
            ...
            <li class="px-[8px]">
              <div class="mt-[11px]">
                <p v-for="ci in layerFiles[element.name]" class="text-[12px]  mb-[8px] last:mb-[0] border-b-[1px] border-[rgba(255,255,255,0.8)] dark:border-[rgba(0,156,228,0.2)] pb-[8px] last:border-none">
    ...
    <div class="mb-[15px]">
      ...
      <div class="fixed flex items-center justify-center w-full h-full z-[100] top-0 left-0" role="status" 
        ...
        <div
          @click="closePopup()"
          class="walletModal__overlay bg-black opacity-[0.7] absolute h-full w-full"
        ></div>
        <div
        ...
        >
          ...
          <div v-if="completedGenerate">
            ...
            <h3
              class="text-[20px] font-bold mb-[8px] text-heading dark:text-white leading-[23px] relative mt-[14px]"
            >
            ...
            <div class="text-center flex justify-center relative">
              ...
              >Cancel</button>
              <button
                class="btn-larger btn-gradient hover:hover-button box-gradient text-white ml-[12px]"
                @click="goToList()"
              >View Artwork</button>
            </div>
          </div>
          ...
          <div v-else>
            <svg
              aria-hidden="true"
              class="mx-auto w-8 h-8 text-heading animate-spin dark:text-white fill-primary"
              viewBox="0 0 100 101" 
              fill="none"
