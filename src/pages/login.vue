                    ...
                    <form>
                        ...
                        <div class="mb-6">
                            <input type="text"
                                ...
                                id="exampleFormControlInput2" placeholder="Username" v-model="username" />
                        </div>
...
export default {
    ...
    methods: {
        doLogin: async function () {
            let check = null;
            try {
                check = await axios("https://api-art-gen.dev-latteprint.com/login", {
                    method: "POST",
                    data: {
                        user: this.username,
            ...
            if (check.data) {
                localStorage.setItem("my-access-token", check.data);
